..  About this file
    The file contains a ReST Chapter titled "Open Dylan Compiler Glossary"
...
.. _chapter-opendylan-compiler-glossary:

*********************************
OpenDylan Compiler Glossary          
*********************************
...
Note:
 ...
 - All other links, which do not contain a '@'  are internal 
   to this *OpenDylan Compiler Glossary*.




.. include:: ./terms/about-the-compiler.txt
